...
VALUES( '2', '2024-06-01 20:00:00', '+54 1812 2022', 'Lionel', 'LioM10@gmail.com', '3');
...
VALUES('Milanesas', 'A delightful blend of perfectly seasoned meat and a golden, crispy coating, delivering a tantalizing taste experience', 1, 4, '2023-01-29 11:00:00');
...
INSERT INTO Reservation (number_of_guests, created_date, contact_phonenumber, contact_name, contact_email, meal_id)
VALUES('7', '2024-01-29 20:30:00', '+966 7007 0770', 'Cristiano', 'CR7@gmail.com', '2');

INSERT INTO Reservation (number_of_guests, created_date, contact_phonenumber, contact_name, contact_email, meal_id)
VALUES( '9', '2024-06-01 20:00:00', '+47 2023 0009', 'Erling', 'Viking@gmail.com', '3');

-- review
INSERT INTO `Review` (title, description, meal_id, stars, created_date)
VALUES( 'Milanesas', 'A delightful blend of perfectly seasoned meat and a golden, crispy coating, delivering a tantalizing taste experience', 1, 5, '2023-01-29 11:00:00');

INSERT INTO `Review` (title, description, meal_id, stars, created_date)
VALUES( 'Empanadas', 'These empanadas boasted a delightful fusion of flavors within their golden, crispy pastry, a true culinary delight.', 2, 4, '2023-05-10 14:00:00');

INSERT INTO `Review` (title, description, meal_id, stars, created_date)
VALUES('Stegt flæsk med persillesovs', 'Crispy, perfectly paired with creamy parsley sauce, a quintessential Danish comfort dish', 3, 3, '2023-06-06 18:00:00');
...
GROUP BY meal.id
HAVING COALESCE(total_reservations, 0) < meal.max_reservations;
