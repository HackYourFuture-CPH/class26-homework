...
console.log("Task 1");
const shortTituleName = movies.filter((movie) => movie.title.length < 5);
console.log(shortTituleName);

console.log("Task 2");
const longTituleName = movies.filter((movie) => movie.title.length > 5);
console.log(longTituleName);
...
console.log("Task 8");
const accumulatedRating = movies.reduce((accumulator, currentMovie) => {
  return accumulator + currentMovie.rating;
}, 0);

const averageRating = (accumulatedRating / movies.length).toFixed(1);
